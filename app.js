...
app.use('/admin',adminRouter.routes); // this is middle ware that will tell that we /////are going to use this router in the admin file  that means we are going to use ////////adming.js file  by this we will route this file
